defmodule Hexa do
  ...
  ## Examples
      ...
      iex> Hexa.config([:files, :uploads_dir])
      iex> Hexa.config([:files, :host, :port])
  """
  def config([main_key | rest] = keyspace) when is_list(keyspace) do
    main = Application.fetch_env!(:hexa, main_key)
  ...
  ## Examples
      ...
      iex> Hexa.attach(MyModule, to: {Accounts, Accounts.Events.UserUpdated})
      :ok

      iex> Hexa.execute(Accounts, %Accounts.Events.UserUpdated{user: new_user})
  """
