defmodule HexaWeb.ProfileLive.UploadFormComponent do
  use HexaWeb, :live_component

  alias Hexa.{MediaLibrary, MP3Stat}
  alias HexaWeb.ProfileLive.SongEntryComponent
    ...
    consume_uploaded_entry(socket, entry, fn %{path: path} ->
      Task.Supervisor.start_child(Hexa.TaskSupervisor, fn ->
        send_update(lv, __MODULE__,
          ...
          action: {:duration, entry.ref, Hexa.MP3Stat.parse(path)}
        )
      end)
