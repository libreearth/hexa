defmodule HexaWeb.MapLayoutComponent do
  @moduledoc """
  ...
  def show_modal(module, attrs) do
    send_update(__MODULE__, id: "maplayout", show: Enum.into(attrs, %{module: module}))
  end

  def hide_modal do
    send_update(__MODULE__, id: "maplayout", show: nil)
  end
