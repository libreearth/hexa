defmodule HexaWeb.LiveHelpers do
  ...
  def profile_path(username, action) when is_binary(username) do
    Routes.profile_path(HexaWeb.Endpoint, action, username)
  end
  ...
  ## Examples
      ...
      <.dropdown id={@id}>
        ...
        <:link navigate={Routes.settings_path(HexaWeb.Endpoint, :edit)}Settings</:link>
      </.dropdown>
  """
