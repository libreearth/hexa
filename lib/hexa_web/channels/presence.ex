defmodule HexaWeb.Presence do
  ...
  use Phoenix.Presence,
    otp_app: :hexa,
    pubsub_server: Hexa.PubSub

  import Phoenix.LiveView.Helpers
  import HexaWeb.LiveHelpers

  alias Hexa.{Accounts, MediaLibrary}
  alias HexaWeb.Presence.BadgeComponent

  def subscribe(%MediaLibrary.Profile{} = profile) do
    Hexa.PresenceClient.subscribe(profile)
  end
...
defmodule HexaWeb.Presence.BadgeComponent do
