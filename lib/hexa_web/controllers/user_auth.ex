defmodule HexaWeb.UserAuth do
  ...
  def log_out_user(conn) do
    if live_socket_id = get_session(conn, :live_socket_id) do
      HexaWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  def require_authenticated_admin(conn, _opts) do
    ...
    if user && Hexa.Accounts.admin?(user) do
  ...
  def signed_in_path(conn) do
    HexaWeb.LiveHelpers.profile_path(conn.assigns.current_user)
  end
end
