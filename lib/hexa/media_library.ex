defmodule Hexa.MediaLibrary do
  @moduledoc """
  ...
  alias Hexa.{Repo, MP3Stat, Accounts}
  alias Hexa.MediaLibrary.{Profile, Song, Events, Genre}
  ...
  def attach do
    Hexa.attach(__MODULE__, to: {Accounts, Accounts.Events.PublicSettingsChanged})
  end
  ...
  def list_active_profiles(opts) do
    from(s in Song,
      inner_join: u in Hexa.Accounts.User,
      on: s.user_id == u.id,
