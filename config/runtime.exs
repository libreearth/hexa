...
if System.get_env("PHX_SERVER") && System.get_env("RELEASE_NAME") do
  config :hexa, HexaWeb.Endpoint, server: true
end
...
if config_env() == :prod do
  ...
  config :hexa, :files,
    ...
    server_ip: System.fetch_env!("HEXA_SERVER_IP"),
    hostname: "livebeats.local",
    transport_opts: [inet6: true]


  config :hexa, :github,
    client_id: System.fetch_env!("HEXA_GITHUB_CLIENT_ID"),
    client_secret: System.fetch_env!("HEXA_GITHUB_CLIENT_SECRET")
