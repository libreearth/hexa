defmodule HexaWeb.UserAuthTest do
  use HexaWeb.ConnCase, async: true

  alias Hexa.Accounts
  alias HexaWeb.UserAuth
  import Hexa.AccountsFixtures

  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, HexaWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      HexaWeb.Endpoint.subscribe(live_socket_id)
